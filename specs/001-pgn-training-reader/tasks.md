...
- [x] T005 [P] Create a disposable Dart research test under `research/prototypes/dartchess_probe/`. Verify parsing of standard PGN, `SetUp` plus `FEN`, comments, NAGs, one variation, and a nested variation. Record outcomes in `research.md`.
